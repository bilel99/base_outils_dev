            ...
            <div class="col-md-7 col-md-offset-2">
                ...
                <div class="panel panel-login">
                    <div class="panel-heading">
                        <div class="row">
                            <p>Rédaction d'une Actualités</p>
                        </div>
                        <hr>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                {!! Form::open(['method' => 'post', 'url' => route('actu.store')]) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('id_langues', $langue, '', ['class'=>'form-control']) !!}
                                </div>
                                <!-- Fin function List -->
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('titre', '', array('class'=>'form-control', 'name'=>'titre', 'placeholder' => 'Titre', 'required'=>'required')) !!}
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('description', ' ', array('class'=>'form-control', 'name'=>'description', 'placeholder' => 'Description', 'required'=>'required')) !!}
                                </div>
